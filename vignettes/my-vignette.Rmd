...
---
This vignette will explains the functions of LR package to compute the linear regression model where computations are done using OLS (Ordinary Least Squares) and gives examples on how to use them.
